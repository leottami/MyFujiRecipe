...
description: Design user interfaces. Use when creating layouts, wireframes, or UI specifications. Covers design principles and UI patterns. Check for existing Stitch designs first.
---
...
**IMPORTANT**: Before creating new designs, check if designs already exist in Google Stitch:

1. Ask user: "Do you have existing designs in Stitch?"
2. If YES → Use [stitch-integration](../stitch-integration/SKILL.md) skill
3. If NO → Proceed with this skill to create new designs
